...
export default {
  ...
  termsandconditions: {
    terms: `Welcome to Lost Heritage!
    ...
    You hereby grant Lost Heritage a non - exclusive license to use, reproduce, edit and authorize others to use, reproduce and edit any of your Comments in any and all forms, formats or media.
